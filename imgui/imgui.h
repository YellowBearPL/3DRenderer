...
namespace ImGui
{
    ...
    // - Important: default value "imgui.ini" is relative to current working direction! Most apps will want to lock this to an absolute path (e.g. same path as executables).
...
struct ImGuiIO
{
    ...
    const char* IniFilename;                    // = "imgui.ini"    // Path to .ini file (important: default "imgui.ini" is relative to current working direction!). Set NULL to disable automatic .ini loading/saving or if you want to manually call LoadIniSettingsXXX() / SaveIniSettingsXXX() functions.
